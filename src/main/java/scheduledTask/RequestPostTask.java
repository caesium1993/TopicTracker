...
public class RequestPostTask implements Runnable {
    ...
    //protected List<Post> returnedPosts;
    public Hashtable<Long, TumblrPost> posts;
    private FileWriter fw;
    private Gson gson = new Gson();

    public RequestPostTask(String consumer_key, String consumer_secret, String access_token, String token_secret,
                           ArrayList<String> blogLists, Hashtable<Long, TumblrPost> posts) {
        ...
        try { this.fw = new FileWriter(dir);
    ...
    public void run() {
        ...
        for(String blogName:this.blogLists){
            ...
            try {
                this.posts = getPostsForGivenBlogs(client.blogPosts(blogName, param), this.posts);
            } catch (IOException e) {
                e.printStackTrace();
            }
            i++;
    ...
    public Hashtable<Long, TumblrPost> getPostsForGivenBlogs(List<Post> returnedPosts,
        ...
        for(Post item:returnedPosts){
            if(posts.containsKey(item.getId())==false){
                ...
                switch (type){
                    case "text":TextPost tPost = (TextPost) item;
                        ...
                        break;
                    case "photo":PhotoPost pPost = (PhotoPost) item;
                        ...
                        break;
                    case "quote":QuotePost qPost = (QuotePost) item;
                        ...
                        break;
                    case "link":LinkPost lPost = (LinkPost) item;
                        ...
                        break;
                    case "chat": ChatPost cPost = (ChatPost) item;
                        ...
                        break;
                    case "audio": AudioPost aPost = (AudioPost) item;
                        ...
                        break;
                    case "video": VideoPost vPost = (VideoPost) item;
                        ...
                        break;
                    case "answer": AnswerPost ansPost = (AnswerPost) item;
