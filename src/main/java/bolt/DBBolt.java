...
public class DBBolt extends BaseRichBolt {
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector outputCollector) {
        ...
        try {
            this.fw = new FileWriter(dir,false);
            this.fw_off = new FileWriter(dirOffTopic,false);
    ...
    private String setTableDir() {
        String dir = "data/output/table_round_";
        dir = dir + Integer.toString(this.round)+".json";
        return dir;
    }

    private String setOffTableDir() {
        String dir = "data/output/table_off_topic_round_";
        dir = dir + Integer.toString(this.round)+".json";
        return dir;
    }
